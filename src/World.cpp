...
void World::spawnHoles(sf::Time dt)
{
    ...
    else
    {
        ...
        int mHolePosition = (int) (r * (512 - deltaBord * 2 - pipeHole)
                               + deltaBord);
        // Add pipes
        ...
        std::unique_ptr<Pipe> pipeBottom(new Pipe(Pipe::PipeBottom, mTextures, sf::Vector2f(500.f, mHolePosition + pipeHole)));
